...
const LR2_PATH =
  "https://www.mccormick.northwestern.edu/contact/tech-room-finder-map.php?id=L171&room-floor=1&room-id=789&room-ingress=";
      ...
      <CardHeader>
        ...
        <CardDescription className="space-y-1.5">
          <span className="block">
            Opt-in is closed. Head to <strong>LR2 by 2:00 PM</strong> to watch teams present their projects and vote for
            your favorite.
          </span>
        </CardDescription>
      </CardHeader>
