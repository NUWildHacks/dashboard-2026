...
export const TeamResultCard = ({ team }: { team: MatchedTeam }) => {
  ...
  return (
    <Card className="shadow-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-24 h-1.5 rounded-full bg-muted overflow-hidden">
                <div className="h-full rounded-full bg-primary" style={{ width: `${team.score}%` }} />
              </div>
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        {(team.match_reasons.length > 0 || team.notes.length > 0) && (
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <p className="text-xs font-medium text-muted-foreground">Pros</p>
            ...
            <div className="flex flex-col gap-1">
              <p className="text-xs font-medium text-yellow-700">Cons</p>
              {team.notes.length > 0 ? (
                <ul className="list-disc pl-3.5 space-y-0.5">
