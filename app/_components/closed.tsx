...
const Closed = () => {
  return (
    <>
      ...
      <p>
        Registration for participants, judges, and mentors are now closed, but the excitement is just getting started.
        For those joining us for the weekend, get ready to build something amazing in 24 hours alongside hundreds of
