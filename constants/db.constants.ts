...
export const PERMISSION_CODES_COLLECTION = "permission_codes" as const;
...
export const TEAM_MATCHING_INTAKE_COLLECTION = "team_matching_intake" as const;
...
export const TEAM_MATCHING_SUGGESTIONS_COLLECTION = "team_matching_suggestions" as const;
