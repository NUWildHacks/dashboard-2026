import { DASHBOARD_MANAGE_USERS_PATH, DASHBOARD_PATH, DASHBOARD_PROJECT_PATH, DASHBOARD_SCHEDULE_PATH, DASHBOARD_SETTINGS_PATH, DASHBOARD_SUPPORT_PATH, LOGIN_PATH, REGISTRATION_PATH, ROOT_PATH } from "@/constants";
